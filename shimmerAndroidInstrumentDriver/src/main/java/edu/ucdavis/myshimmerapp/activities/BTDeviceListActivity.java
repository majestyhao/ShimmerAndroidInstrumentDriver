...
public class BTDeviceListActivity extends MyServiceActivity{
    // Debugging
...
//                v.setVisibility(View.GONE);
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.btdeviceitem);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.btdeviceitem);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // When discovery is finished, change the Activity title
                ...
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    String noDevices = getResources().getText(R.string.no_device_found).toString();
